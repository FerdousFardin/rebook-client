          ...
          <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
            ...
            <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
              ...
              <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                ...
                state. Let us briefly explore a few of them in this part. URL 1.
                We can use URL to store some data e.g., 2. The id of the current
                item, being viewed, 3. Filter parameters Pagination offset and
                limit Sorting data Web Storage The second option is to store the
                state in the browser via web storage. This is useful when we
                want to persist state between reloads and reboots. Examples
                include cookies, local storage, and IndexedDB. These are native
                browser technologies. Data persisted in the browser is tied to a
                single browser. So, if the user loads the site in a different
                browser, the data will not be available. Local State The third
                option is to use store state locally. It is useful when one
                component needs the state. Examples include a toggle button, a
                form, etc. Lifted State The Fourth option is to define the state
                in the parent component. Often, the same state is used across
                multiple components. In those cases, it is useful to lift the
                state to a common parent. The lifting state is a two‑step
                process. First, we declare the state in a common parent
                component, and then we pass the state down to child components
                via props.
              </p>
          ...
          <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
            ...
            <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
              ...
              <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                ...
                determine if it works as intended. A unit test typically
                comprises of three stages: plan, cases and scripting and the
                unit test itself. In the first step, the unit test is prepared
                and reviewed. The next step is for the test cases and scripts to
                be made, then the code is tested.
              </p>
              ...
              <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                <ol>
                  <li>
                    ...
                    <ul>
                      <li>
                        React is the JavaScript library of User Interfaces. It
                        is build single-page applications and also allows you to
                        create reusable UI components.
                      </li>
                      <li>
                        Popularity – React has gained a lot of popularity in
                        recent years and is considered one of the best
                        frameworks for web development. There are more
                        developers who keep React as a priority for creating
                        wonderful websites.
                      </li>
                      <li>
                        Architecture – It does not follow any specific pattern,
                        developers have the freedom to choose any design
                        pattern. It begins with a single root component. Each
                        can be nested with another component.{" "}
                      </li>
                      <li>
                        Ecosystem – React has excellent open-source packages
                        that could be used for developing applications.
                        Front-end applications rely on global state management
                        (Redux) used to store information
                      </li>
                      <li>
                        Features – React follows the “Learn Once, Write
                        Anywhere” feature which helps developers to integrate
                        new features without the need of rewriting the existing
                        code. It also has declarative views for each state which
                        will efficiently update and render the components as per
                        the change in data. It has virtual DOM{" "}
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        regular DOM. Angular provides a set of tools using which
                        a complex, reactive UI can be built.{" "}
                      </li>
                      <li>
                      ...
                      <li>
                        Architecture – Angular follows MVC
                        (Model-View-Controller) architecture, also you don’t
                        have restrictions in following only MVC architecture
                      </li>
                      <li>
                      ...
                      <li>
                        Features – The new version of Angular8 comes with
                        immense features such as it supports cross-platform,
                        two-way data binding, a set of directives, declarative
                        UI, a real DOM, CLI (Command Line Interface), and many
                        more.{" "}
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        best version of Angular and make a custom tool. It is
                        used for developing single-page engaging and
                      ...
                      <li>
                        ...
                        framework are UpWork, Netflix, and Nintendo. It has a
                        good rating on GitHub making it so popular.{" "}
                      </li>
                      <li>
                        Architecture – Vue is called a progressive framework
                        where you can extend functionality using third-party
                        packages. It follows the MVVM (Model View ViewModel)
                        pattern but is also not strictly linked to it.
                      </li>
                      <li>
                        ...
                        development, it has input components and advanced
                        elements
                      </li>
                      <li>
                        ...
                        reusing codes, and transitions that provides methods
                        when a UI element is removed or inserted in the DOM.
                      </li>
                    </ul>
                  </li>
                </ol>
